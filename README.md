...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7b52babb-145b-4ce6-998f-75ea52b85737
```

> `7b52babb-145b-4ce6-998f-75ea52b85737` is the password of the certificate, you can change it to any password you want.
